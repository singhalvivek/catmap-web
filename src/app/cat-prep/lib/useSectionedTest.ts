// useSectionedTest — manages timers, navigation, and answer state for any multi-section timed test
"use client";
...
export type TestHook = ReturnType<typeof useSectionedTest>;

export function useSectionedTest(test: DailyTest, draft?: DailyChallengeDraft) {
  ...
  // No goToPrevSection exists by design — sections are forward-only once started.
