      ...
      <nav className="bg-white border-b border-calm-border sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link href="/cat-prep" className="btn-primary py-2 px-6 text-sm">Browse Roadmaps</Link>
          </div>
        </div>
      </nav>
            ...
            {courses.map((course, index) => (
              ...
              >
                ...
                <div className="text-right">
                  <Link href="/cat-prep" className="btn-primary inline-flex items-center gap-2">
                    Roadmap <span>→</span>
                  </Link>
                </div>
              </div>
